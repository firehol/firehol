	...
	do
		...
		case $tproto in
				...
				tcp|TCP)
						...
						[ $ack -eq 1 ] && local ack_arg="match u8 0x10 0xff at nexthdr+13 match u16 0x0000 0xffc0 at 2"
						
						# I figured this out, based on the above - It seems to work
						[ $syn -eq 1 ] && local syn_arg="match u8 0x02 0xff at nexthdr+13 match u16 0x0000 0xffc0 at 2"
						;;
