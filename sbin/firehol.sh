...
# $PROGRAM_DIR/firehol.sh, while developing, without having to autoreconf
# in order to generate $PROGRAM_DIR/firehol.
if [ "`${BASENAME_CMD} "$0"`" = "$PROGRAM_DIR/firehol.sh" ] && [ -f $PROGRAM_DIR/simple_services.sh ]
then
